...
from config import FPS, WIDTH, HEIGHT, FULLSCREEN, FONT_PATH, FONT_SIZE, NAME, ADDRESS, BACKGROUND_COLOR, PRIMARY_COLOR, HIJRI_MONTH_NAMES
...
def main():
    ...
    while running:
        ...
        address_surface = font.render(ADDRESS, True, PRIMARY_COLOR)
